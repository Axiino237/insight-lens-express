...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — First Solutions" },
      { name: "description", content: "Drop your brief. We'll respond within 24 hours." },
      { property: "og:title", content: "Contact — First Solutions" },
      ...
      <section className="pb-24">
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <InfoCard icon={Phone} title="Call" lines={["+91 98000 00000", "Mon–Sat · 10am to 8pm IST"]} accent="text-brand-cyan" />
            <InfoCard icon={MapPin} title="Visit" lines={["12 Boat Club Road", "Chennai 600028, India"]} accent="text-brand-magenta" />
          </div>
        </div>
      </section>
    </>
